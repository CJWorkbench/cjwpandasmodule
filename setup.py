...
from cjwpandasmodule import __version__
...
setup(
    ...
    version=__version__,
    url="http://github.com/CJWorkbench/cjwpandasmodule/",
    author="Adam Hooper",
    author_email="adam@adamhooper.com",
    description="Utilities to help build Workbench modules with Pandas",
    ...
    install_requires=["cjwmodule>=1.4.1"],
